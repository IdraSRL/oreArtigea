      ...
      <div class="employee-badge mx-auto">
        <div class="badge-header">
          <div class="d-flex align-items-center justify-content-center gap-2">
            <img src="${this.companyData.logoAzienda}" alt="Logo" class="company-logo"
                 onerror="this.src='../assets/img/logo.png'">
            <h6 class="company-name mb-0">${this.companyData.nomeAzienda}</h6>
          </div>
        </div>
        
        <div class="badge-body text-center">
          <img src="${this.badgeData.foto}" alt="Foto dipendente" class="employee-photo"
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (window.location.pathname.includes('timeEntry.html')) {
    setTimeout(() => {
      if (window.employeeBadgeManager) {
        window.employeeBadgeManager.init();
      }
    }, 2000); // Ritarda per permettere il caricamento dell'auth
  }
});
